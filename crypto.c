...
static libspectrum_error get_signature( libspectrum_context_t *context,
                                        gcry_mpi_t *r, gcry_mpi_t *s,
                                        libspectrum_byte *data,
                                        size_t data_length,
                                        libspectrum_rzx_dsa_key *key );
static libspectrum_error get_hash( libspectrum_context_t *context,
                                   gcry_sexp_t *hash,
                                   const libspectrum_byte *data,
                                   size_t data_length );
static libspectrum_error create_key( libspectrum_context_t *context,
                                     gcry_sexp_t *s_key,
                                     libspectrum_rzx_dsa_key *key,
                                     int secret_key );
static void free_mpis( libspectrum_context_t *context, gcry_mpi_t *mpis,
                       size_t n );
static libspectrum_error get_mpi( libspectrum_context_t *context,
                                  gcry_mpi_t *mpi, gcry_sexp_t signature,
                                  const char *token );
static libspectrum_error serialise_mpis( libspectrum_context_t *context,
                                         libspectrum_byte **signature,
...
get_signature( libspectrum_context_t *context, gcry_mpi_t *r, gcry_mpi_t *s,
               libspectrum_byte *data, size_t data_length,
               libspectrum_rzx_dsa_key *key )
{
  ...
  error = get_hash( context, &hash, data, data_length );
  if( error ) return error;
...
static libspectrum_error
get_hash( libspectrum_context_t *context, gcry_sexp_t *hash,
          const libspectrum_byte *data, size_t data_length )
{
  gcry_error_t error;
...
static libspectrum_error
create_key( libspectrum_context_t *context, gcry_sexp_t *s_key,
            libspectrum_rzx_dsa_key *key, int secret_key )
{
  gcry_error_t error;
  size_t i;
...
static libspectrum_error
get_mpi( libspectrum_context_t *context, gcry_mpi_t *mpi, gcry_sexp_t sexp,
         const char *token )
{
  gcry_sexp_t pair;
...
static libspectrum_error
serialise_mpis( libspectrum_context_t *context, libspectrum_byte **signature,
                size_t *signature_length, gcry_mpi_t r, gcry_mpi_t s )
{
  gcry_error_t error;
...
libspectrum_error
libspectrum_verify_signature( libspectrum_context_t *context,
